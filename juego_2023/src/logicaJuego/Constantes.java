...
public class Constantes {
	...
	public static final int ROMPE_ROCA_CON_GEMA 		= 0; //si tienes gema puedes romperla
	public static final int GANA_A_LA_ROCA 				= 1; // cuando la magia es menor a 4
	public static final int PIERDE_A_LA_ROCA 			= 2;//cuando la magia es superior a 4
